package com.myspring.SpringMaven_test.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.myspring.SpringMaven_test.*.service.*.*(..)) or "
			+ "execution(* com.myspring.SpringMaven_test.*.dao.*.*(..))")
	...
	/*@After("execution(* com.myspring.pro27.member.service.*.*(..)) or "
			+ "execution(* com.myspring.pro27.member.dao.*.*(..))")*/ 
	@After("execution(* com.myspring.SpringMaven_test.*.service.*.*(..)) or "
			+ "execution(* com.myspring.SpringMaven_test.*.dao.*.*(..))")
	...
	/*@Around("execution(* com.myspring.pro27.member.service.*.*(..)) or "
			+ "execution(* com.myspring.pro27.member.dao.*.*(..))")*/
	@Around("execution(* com.myspring.SpringMaven_test.*.service.*.*(..)) or "
			+ "execution(* com.myspring.SpringMaven_test.*.dao.*.*(..))")
