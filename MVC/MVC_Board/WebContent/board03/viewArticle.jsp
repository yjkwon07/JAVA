...
<script type="text/javascript">
      function backToList(obj){
	    obj.action="${contextPath}/boardC/listArticles.do";
	    obj.submit();
	  }
   	   </script>
</head>
<body>
	<form name="frmArticle" method="post" enctype="multipart/form-data">
	    ...
	    <input type=button value="삭제하기" onClick="fn_remove_article('${contextPath}/board/removeArticle.do', ${article.articleNO})">
					...
					value="삭제하기"
					onClick="fn_remove_article('${contextPath}/boardC/removeArticle.do', ${article.articleNO})">
					<input type=button value="리스트로 돌아가기"
					onClick="backToList(this.form)"> <input type=button
					value="답글쓰기"
					onClick="fn_reply_form('${contextPath}/boardC/replyForm.do', ${article.articleNO})">
				</td>
			</tr>
		</table>
	</form>
